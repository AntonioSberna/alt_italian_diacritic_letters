...
;; Key to stop the script
;;           Space   Esc   Enter  Tab   (add Del and Backspace, I don't know how to do it)
stop_key := Chr(32)Chr(27)Chr(10)Chr(09)
...
;; If any of the stop key is pressed, stop the script
	...
	PosAcuteAcc := InStr(in_char,"'")
	PosGraveAcc := InStr(in_char,Chr(96))
	...
	;;Accented letter to put (I don't know why for the capital letters it is not working)
	...
	;; O with slash symbol "ò" (with double click on "O")
	...
	;; Paragraph symbol "ß" (with double click on "p")
